...
public class StatisticsCounterImpl implements StatisticsCounter {
    ...
    public StatisticsCounterImpl(CollectionService collectionService, BrandRepository brandRepository, IndexService indexService) {
    ...
    @Override
    @Cacheable(value = "industryStatisticsCount")
